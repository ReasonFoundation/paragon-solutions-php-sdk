...
/**
 * CreateTransactionReceiptModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateTransactionReceiptModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransactionReceiptModel';
     ...
     * Sets gateway_id
     *
     * @param string|null $gateway_id The Gateway ID on which the operations are to be performed
     *
     * @return self
     */
     ...
     * Sets email_to
     *
     * @param string|null $email_to Send email to
     *
     * @return self
     */
