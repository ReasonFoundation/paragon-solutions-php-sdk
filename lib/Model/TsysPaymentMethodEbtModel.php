...
/**
 * TsysPaymentMethodEbtModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class TsysPaymentMethodEbtModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TsysPaymentMethodEbtModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fcs_number'] = $data['fcs_number'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fcs_number']) && (mb_strlen($this->container['fcs_number']) < 7)) {
            $invalidProperties[] = "invalid value for 'fcs_number', the character length must be bigger than or equal to 7.";
        }
    ...
    public function setAbaNumber($aba_number)
    {
        ...
        if (!is_null($aba_number) && (mb_strlen($aba_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $aba_number when calling TsysPaymentMethodEbtModel., must be bigger than or equal to 9.');
        }
        if (!is_null($aba_number) && (!preg_match("/^[0-9]*$/", $aba_number))) {
            throw new \InvalidArgumentException("invalid value for $aba_number when calling TsysPaymentMethodEbtModel., must conform to the pattern /^[0-9]*$/.");
        }
     ...
     * @return string|null
     */
    public function getFcsNumber()
    {
        return $this->container['fcs_number'];
    }

    /**
     * Sets fcs_number
     *
     * @param string|null $fcs_number 
     *
     * @return self
     */
    public function setFcsNumber($fcs_number)
    {

        if (!is_null($fcs_number) && (mb_strlen($fcs_number) < 7)) {
            throw new \InvalidArgumentException('invalid length for $fcs_number when calling TsysPaymentMethodEbtModel., must be bigger than or equal to 7.');
        }

        $this->container['fcs_number'] = $fcs_number;
