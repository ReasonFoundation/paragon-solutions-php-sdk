...
/**
 * TransactionReceiptResponse Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class TransactionReceiptResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionReceiptResponse';
     ...
     * Sets result
     *
     * @param string|null $result Numeric value returned from DC Gateway to summarize result from invoking operation
     *
     * @return self
     */
     ...
     * Sets result_message
     *
     * @param string|null $result_message Message returned from DC Gateway describing result from processing transaction
     *
     * @return self
     */
