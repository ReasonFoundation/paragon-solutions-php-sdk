...
/**
 * PaymentMethodResponseModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodResponseModel';
     ...
     *
     * @param string|null $payment_method_profile_key payment_method_profile_key
     *
     * @return self
     */
