...
/**
 * ContractsNextBillDtModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class ContractsNextBillDtModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractsNextBillDtModel';
     ...
     * Sets number_of_days
     *
     * @param string|null $number_of_days The number of days (greater than 0) to be added to the NextBillDt field.
     *
     * @return self
     */
