<?php
/**
 * FirstACHPaymentMethodCheckModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FirstACHPaymentMethodCheckModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class FirstACHPaymentMethodCheckModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirstACHPaymentMethodCheckModel';
     ...
     *
     * @param string|null $create_firstach_account True if account needs to be created in FirstACH,  False if FirstACH login id and transaction key is provided
     *
     * @return self
     */
     ...
     * Sets login_id
     *
     * @param string|null $login_id FirstACH merchant login id
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_key FirstACH transaction key
     *
     * @return self
     */
