...
/**
 * PaymentMethodCartBlanche Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodCartBlanche implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodCartBlanche';
    ...
    public function setCustomerServicePhoneNumber($customer_service_phone_number)
    {
        ...
        if (!is_null($customer_service_phone_number) && (mb_strlen($customer_service_phone_number) < 11)) {
            throw new \InvalidArgumentException('invalid length for $customer_service_phone_number when calling PaymentMethodCartBlanche., must be bigger than or equal to 11.');
        }
    ...
    public function setPurefacOrMarketplaceId($purefac_or_marketplace_id)
    {
        if (!is_null($purefac_or_marketplace_id) && (mb_strlen($purefac_or_marketplace_id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $purefac_or_marketplace_id when calling PaymentMethodCartBlanche., must be smaller than or equal to 11.');
        }
    ...
    public function setPspName($psp_name)
    {
        if (!is_null($psp_name) && (mb_strlen($psp_name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $psp_name when calling PaymentMethodCartBlanche., must be smaller than or equal to 20.');
        }
