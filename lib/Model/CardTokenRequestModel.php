...
/**
 * CardTokenRequestModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class CardTokenRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardTokenRequestModel';
     ...
     * Sets card_number
     *
     * @param string|null $card_number The Primary Acccount Number (PAN) uniquely identifies the issuer and credit cardholder account.  Required for TransType = ADD and UPDATE  Not used for TransType = DELETE
     *
     * @return self
     */
     ...
     *
     * @param string|null $expiration_date Credit card date of expiration (MMYY).  Required for TransType = ADD and UPDATE  Not used for TransType = DELETE
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_reference_number payment reference number can be used in place of point_to_point_encryption   and card_number/expiration_date/name_on_card/street1/zip_code to retrieve token.
     *
     * @return self
     */
