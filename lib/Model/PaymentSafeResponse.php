...
/**
 * PaymentSafeResponse Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class PaymentSafeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentSafeResponse';
     ...
     * Sets card_key
     *
     * @param string|null $card_key Unique identifier assigned by Paragon platform to card.
     *
     * @return self
     */
     ...
     * Sets check_key
     *
     * @param string|null $check_key Unique identifier assigned by Paragon platform to check.
     *
     * @return self
     */
     ...
     * Sets customer_key
     *
     * @param string|null $customer_key Unique identifier assigned by Paragon platform to a customer.
     *
     * @return self
     */
     ...
     * Sets result
     *
     * @param string|null $result Result code returned by Paragon platform for the current operation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $result_description Result message returned by Paragon platform for the current operation.
     *
     * @return self
     */
     ...
     * Sets result_message
     *
     * @param string|null $result_message Result message returned by Paragon platform for the current operation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $result_message_1 Additional text from message returned by Paragon platform for the current operation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $result_message_2 Additional text from message returned by Paragon platform for the current operation.
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username Paragon platform User Name used for the current operation.
     *
     * @return self
     */
