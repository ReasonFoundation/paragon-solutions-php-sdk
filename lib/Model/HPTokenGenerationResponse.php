...
/**
 * HPTokenGenerationResponse Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class HPTokenGenerationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HPTokenGenerationResponse';
     ...
     * Sets hp_plus_key
     *
     * @param string|null $hp_plus_key A unique bearer token provided to perform different operations with the API
     *
     * @return self
     */
     ...
     * Sets result_message
     *
     * @param string|null $result_message result_message
     *
     * @return self
     */
