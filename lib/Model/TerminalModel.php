...
class TerminalModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalModel';
    ...
    protected static $attributeMap = [
        ...
        'terminal_activation_id' => 'terminal_activation_id',
    ...
    protected static $setters = [
        ...
        'terminal_activation_id' => 'setTerminalActivationId',
    ...
    protected static $getters = [
        ...
        'terminal_activation_id' => 'getTerminalActivationId',
    ...
    public const TERMINAL_MODEL_NOTSET = 'NOTSET';
    public const TERMINAL_MODEL_VERIFONE_V200_C = 'VERIFONE_V200C';
    public const TERMINAL_MODEL_VERIFONE_V200_CP = 'VERIFONE_V200CP';
    public const TERMINAL_MODEL_VERIFONE_V400_C = 'VERIFONE_V400C';
    public const TERMINAL_MODEL_VERIFONE_V400_CP = 'VERIFONE_V400CP';
    public const TERMINAL_MODEL_VERIFONE_E285 = 'VERIFONE_E285';
    public const TERMINAL_MODEL_VERIFONE_V400_M = 'VERIFONE_V400M';
    public const TERMINAL_MODEL_VERIFONE_P200 = 'VERIFONE_P200';
    public const TERMINAL_MODEL_VERIFONE_P400 = 'VERIFONE_P400';
     ...
     * @return string[]
     */
    public function getTerminalModelAllowableValues()
    {
        return [
            self::TERMINAL_MODEL_NOTSET,
            self::TERMINAL_MODEL_VERIFONE_V200_C,
            self::TERMINAL_MODEL_VERIFONE_V200_CP,
            self::TERMINAL_MODEL_VERIFONE_V400_C,
            self::TERMINAL_MODEL_VERIFONE_V400_CP,
            self::TERMINAL_MODEL_VERIFONE_E285,
            self::TERMINAL_MODEL_VERIFONE_V400_M,
            self::TERMINAL_MODEL_VERIFONE_P200,
            self::TERMINAL_MODEL_VERIFONE_P400,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['terminal_activation_id'] = $data['terminal_activation_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminal_serial_number'] === null) {
            $invalidProperties[] = "'terminal_serial_number' can't be null";
        }
        if ((mb_strlen($this->container['terminal_serial_number']) > 20)) {
            $invalidProperties[] = "invalid value for 'terminal_serial_number', the character length must be smaller than or equal to 20.";
        }

        if ((mb_strlen($this->container['terminal_serial_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'terminal_serial_number', the character length must be bigger than or equal to 1.";
        }

        $allowedValues = $this->getTerminalModelAllowableValues();
        if (!is_null($this->container['terminal_model']) && !in_array($this->container['terminal_model'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'terminal_model', must be one of '%s'",
                $this->container['terminal_model'],
                implode("', '", $allowedValues)
            );
        }

        if (!is_null($this->container['terminal_activation_id']) && (mb_strlen($this->container['terminal_activation_id']) > 10)) {
            $invalidProperties[] = "invalid value for 'terminal_activation_id', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['terminal_activation_id']) && !preg_match("/[0-9]+/", $this->container['terminal_activation_id'])) {
            $invalidProperties[] = "invalid value for 'terminal_activation_id', must be conform to the pattern /[0-9]+/.";
        }
        ...
        if (!is_null($this->container['polling_interval_sec']) && (mb_strlen($this->container['polling_interval_sec']) > 10)) {
            $invalidProperties[] = "invalid value for 'polling_interval_sec', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!is_null($this->container['polling_frequency_sec']) && (mb_strlen($this->container['polling_frequency_sec']) > 10)) {
            $invalidProperties[] = "invalid value for 'polling_frequency_sec', the character length must be smaller than or equal to 10.";
        }
     ...
     * Sets terminal_key
     *
     * @param string|null $terminal_key ReadOnly - Paragon provided Terminal Key.  Identifies the Terminal Uniquely.
     *
     * @return self
     */
    public function setTerminalKey($terminal_key)
    {
        if (!is_null($terminal_key) && (mb_strlen($terminal_key) > 12)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling TerminalModel., must be smaller than or equal to 12.');
        }
        if (!is_null($terminal_key) && (!preg_match("/[0-9]+/", $terminal_key))) {
            throw new \InvalidArgumentException("invalid value for $terminal_key when calling TerminalModel., must conform to the pattern /[0-9]+/.");
        }
     ...
     * Sets terminal_id
     *
     * @param string|null $terminal_id Optional - Unique terminal identifier for this merchant.
     *
     * @return self
     */
    public function setTerminalId($terminal_id)
    {
        if (!is_null($terminal_id) && (mb_strlen($terminal_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling TerminalModel., must be smaller than or equal to 20.');
        }
        if (!is_null($terminal_id) && (!preg_match("/[A-Za-z0-9]+/", $terminal_id))) {
            throw new \InvalidArgumentException("invalid value for $terminal_id when calling TerminalModel., must conform to the pattern /[A-Za-z0-9]+/.");
        }
     ...
     *
     * @param string $terminal_serial_number Required - Unique Terminal Serial Number (must match actual terminal serial number)
     *
     * @return self
     */
    public function setTerminalSerialNumber($terminal_serial_number)
    {
        if ((mb_strlen($terminal_serial_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_serial_number when calling TerminalModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($terminal_serial_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_serial_number when calling TerminalModel., must be bigger than or equal to 1.');
        }
    ...
    {
        $allowedValues = $this->getTerminalModelAllowableValues();
        if (!is_null($terminal_model) && !in_array($terminal_model, $allowedValues, true)) {
    ...
    /**
     * Gets terminal_activation_id
     *
     * @return string|null
     */
    public function getTerminalActivationId()
    {
        return $this->container['terminal_activation_id'];
    }

    /**
     * Sets terminal_activation_id
     *
     * @param string|null $terminal_activation_id ReadOnly - Terminal Acitvation Code
     *
     * @return self
     */
    public function setTerminalActivationId($terminal_activation_id)
    {
        if (!is_null($terminal_activation_id) && (mb_strlen($terminal_activation_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $terminal_activation_id when calling TerminalModel., must be smaller than or equal to 10.');
        }
        if (!is_null($terminal_activation_id) && (!preg_match("/[0-9]+/", $terminal_activation_id))) {
            throw new \InvalidArgumentException("invalid value for $terminal_activation_id when calling TerminalModel., must conform to the pattern /[0-9]+/.");
        }

        $this->container['terminal_activation_id'] = $terminal_activation_id;
    ...
    public function setTerminalServiceMode($terminal_service_mode)
    {
        if (!is_null($terminal_service_mode) && (mb_strlen($terminal_service_mode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_service_mode when calling TerminalModel., must be smaller than or equal to 1.');
        }
        if (!is_null($terminal_service_mode) && (!preg_match("/[0-9]+/", $terminal_service_mode))) {
            throw new \InvalidArgumentException("invalid value for $terminal_service_mode when calling TerminalModel., must conform to the pattern /[0-9]+/.");
        }
     ...
     *
     * @param string|null $polling_interval_sec Optional - Terminal Polling Interval
     *
     * @return self
     */
    public function setPollingIntervalSec($polling_interval_sec)
    {
        if (!is_null($polling_interval_sec) && (mb_strlen($polling_interval_sec) > 10)) {
            throw new \InvalidArgumentException('invalid length for $polling_interval_sec when calling TerminalModel., must be smaller than or equal to 10.');
        }
        if (!is_null($polling_interval_sec) && (!preg_match("/[0-9]+/", $polling_interval_sec))) {
            throw new \InvalidArgumentException("invalid value for $polling_interval_sec when calling TerminalModel., must conform to the pattern /[0-9]+/.");
        }
     ...
     *
     * @param string|null $polling_frequency_sec Optional - Terminal Polling Frequency
     *
     * @return self
     */
    public function setPollingFrequencySec($polling_frequency_sec)
    {
        if (!is_null($polling_frequency_sec) && (mb_strlen($polling_frequency_sec) > 10)) {
            throw new \InvalidArgumentException('invalid length for $polling_frequency_sec when calling TerminalModel., must be smaller than or equal to 10.');
        }
        if (!is_null($polling_frequency_sec) && (!preg_match("/[0-9]+/", $polling_frequency_sec))) {
            throw new \InvalidArgumentException("invalid value for $polling_frequency_sec when calling TerminalModel., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setMaintenanceStartTime($maintenance_start_time)
    {
        if (!is_null($maintenance_start_time) && (mb_strlen($maintenance_start_time) > 12)) {
            throw new \InvalidArgumentException('invalid length for $maintenance_start_time when calling TerminalModel., must be smaller than or equal to 12.');
        }
    ...
    public function setMaintenanceEndTime($maintenance_end_time)
    {
        if (!is_null($maintenance_end_time) && (mb_strlen($maintenance_end_time) > 12)) {
            throw new \InvalidArgumentException('invalid length for $maintenance_end_time when calling TerminalModel., must be smaller than or equal to 12.');
        }
