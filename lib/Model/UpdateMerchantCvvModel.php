...
/**
 * UpdateMerchantCvvModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMerchantCvvModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMerchantCvvModel';
    ...
    protected static $openAPITypes = [
        ...
        'accept_not_processed' => 'string',
        'accept_not_present' => 'string',
        'accept_no_data_from_issuer' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'accept_not_processed' => null,
        'accept_not_present' => null,
        'accept_no_data_from_issuer' => null,
    ...
    protected static $attributeMap = [
        ...
        'accept_not_processed' => 'accept_not_processed',
        'accept_not_present' => 'accept_not_present',
        'accept_no_data_from_issuer' => 'accept_no_data_from_issuer',
    ...
    protected static $setters = [
        'accept_match' => 'setAcceptMatch',
        'accept_no_match' => 'setAcceptNoMatch',
        'accept_not_processed' => 'setAcceptNotProcessed',
        'accept_not_present' => 'setAcceptNotPresent',
        'accept_no_data_from_issuer' => 'setAcceptNoDataFromIssuer',
    ...
    protected static $getters = [
        'accept_match' => 'getAcceptMatch',
        'accept_no_match' => 'getAcceptNoMatch',
        'accept_not_processed' => 'getAcceptNotProcessed',
        'accept_not_present' => 'getAcceptNotPresent',
        'accept_no_data_from_issuer' => 'getAcceptNoDataFromIssuer',
    ...
    {
        $this->container['accept_match'] = $data['accept_match'] ?? null;
        $this->container['accept_no_match'] = $data['accept_no_match'] ?? null;
        $this->container['accept_not_processed'] = $data['accept_not_processed'] ?? null;
        $this->container['accept_not_present'] = $data['accept_not_present'] ?? null;
        $this->container['accept_no_data_from_issuer'] = $data['accept_no_data_from_issuer'] ?? null;
    ...
    {
        return $this->container['accept_match'];
    }

    /**
     * Sets accept_match
     *
     * @param string|null $accept_match Accept (T) transactions for which CV service reports code matches.
     *
     * @return self
     */
    public function setAcceptMatch($accept_match)
    {
        $this->container['accept_match'] = $accept_match;
     ...
     *
     * @param string|null $accept_no_match Accept (T) transactions for which CV service reports code does not match.
     *
     * @return self
     */
    ...
    /**
     * Gets accept_not_processed
     *
     * @return string|null
     */
    public function getAcceptNotProcessed()
    {
        return $this->container['accept_not_processed'];
    }

    /**
     * Sets accept_not_processed
     *
     * @param string|null $accept_not_processed Accept (T) transactions not processed through CV service.
     *
     * @return self
     */
    public function setAcceptNotProcessed($accept_not_processed)
    {
        $this->container['accept_not_processed'] = $accept_not_processed;

        return $this;
    }

    /**
     * Gets accept_not_present
     *
     * @return string|null
     */
    public function getAcceptNotPresent()
    {
        return $this->container['accept_not_present'];
    }

    /**
     * Sets accept_not_present
     *
     * @param string|null $accept_not_present Accept (T) transactions for which CV service reports code not provided.
     *
     * @return self
     */
    public function setAcceptNotPresent($accept_not_present)
    {
        $this->container['accept_not_present'] = $accept_not_present;

        return $this;
    }

    /**
     * Gets accept_no_data_from_issuer
     *
     * @return string|null
     */
    public function getAcceptNoDataFromIssuer()
    {
        return $this->container['accept_no_data_from_issuer'];
    }

    /**
     * Sets accept_no_data_from_issuer
     *
     * @param string|null $accept_no_data_from_issuer Accept (T) transactions for which CV service reports no code provided from issuing bank for card number.
     *
     * @return self
     */
    public function setAcceptNoDataFromIssuer($accept_no_data_from_issuer)
    {
        $this->container['accept_no_data_from_issuer'] = $accept_no_data_from_issuer;
     ...
     *
     * @param string|null $accept_unrecognized_code Accept (T) transactions for which CV service returns unrecognized result.
     *
     * @return self
     */
     ...
     * Sets accept_no_data
     *
     * @param string|null $accept_no_data Accept (T) transactions for which CV service returns no result.
     *
     * @return self
     */
