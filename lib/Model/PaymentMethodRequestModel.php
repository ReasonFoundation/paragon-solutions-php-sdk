...
/**
 * PaymentMethodRequestModel Class Doc Comment
 *
 * @category Class
 * @description Payment Method Objects  Note: When Adding or Updating a payment method ONLY Populate one Payment Method Object
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodRequestModel';
    ...
    protected static $openAPITypes = [
        'tsys_payment_method' => '\DCarbone\ParagonSolutionsPHPSDK\Model\TsysPaymentMethodModel',
        'firstach_payment_method' => '\DCarbone\ParagonSolutionsPHPSDK\Model\FirstACHPaymentMethodModel'
    ];
    ...
    protected static $openAPIFormats = [
        'tsys_payment_method' => null,
        'firstach_payment_method' => null
    ];
    ...
    protected static $attributeMap = [
        'tsys_payment_method' => 'tsys_payment_method',
        'firstach_payment_method' => 'firstach_payment_method'
    ];
    ...
    protected static $setters = [
        'tsys_payment_method' => 'setTsysPaymentMethod',
        'firstach_payment_method' => 'setFirstachPaymentMethod'
    ];
    ...
    protected static $getters = [
        'tsys_payment_method' => 'getTsysPaymentMethod',
        'firstach_payment_method' => 'getFirstachPaymentMethod'
    ];
    ...
    {
        $this->container['tsys_payment_method'] = $data['tsys_payment_method'] ?? null;
        $this->container['firstach_payment_method'] = $data['firstach_payment_method'] ?? null;
    }
    ...
    /**
     * Gets tsys_payment_method
     *
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\TsysPaymentMethodModel|null
     */
    public function getTsysPaymentMethod()
    {
        return $this->container['tsys_payment_method'];
    }

    /**
     * Sets tsys_payment_method
     *
     * @param \DCarbone\ParagonSolutionsPHPSDK\Model\TsysPaymentMethodModel|null $tsys_payment_method tsys_payment_method
     *
     * @return self
     */
    public function setTsysPaymentMethod($tsys_payment_method)
    {
        $this->container['tsys_payment_method'] = $tsys_payment_method;

        return $this;
    }

    /**
     * Gets firstach_payment_method
     *
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\FirstACHPaymentMethodModel|null
     */
    public function getFirstachPaymentMethod()
    {
        return $this->container['firstach_payment_method'];
    }

    /**
     * Sets firstach_payment_method
     *
     * @param \DCarbone\ParagonSolutionsPHPSDK\Model\FirstACHPaymentMethodModel|null $firstach_payment_method firstach_payment_method
     *
     * @return self
     */
    public function setFirstachPaymentMethod($firstach_payment_method)
    {
        $this->container['firstach_payment_method'] = $firstach_payment_method;
