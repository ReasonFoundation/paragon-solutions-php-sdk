...
/**
 * CashReportFilterModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class CashReportFilterModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashReportFilterModel';
    ...
    public function setMerchantKey($merchant_key)
    {
        if ((mb_strlen($merchant_key) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_key when calling CashReportFilterModel., must be smaller than or equal to 10.');
        }
