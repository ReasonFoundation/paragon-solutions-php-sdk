...
/**
 * CardReportFilterModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class CardReportFilterModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardReportFilterModel';
     ...
     * Sets auth_code
     *
     * @param string|null $auth_code Identifier assigned by processor
     *
     * @return self
     */
     ...
     * Sets approval_code
     *
     * @param string|null $approval_code Identifier assigned by the merchant to locate a specific transaction or multiple transactions (grouped by a single invoice).
     *
     * @return self
     */
    ...
    public function setMerchantKey($merchant_key)
    {
        if ((mb_strlen($merchant_key) > 10)) {
            throw new \InvalidArgumentException('invalid length for $merchant_key when calling CardReportFilterModel., must be smaller than or equal to 10.');
        }
