...
/**
 * GetTicketRequestModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetTicketRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTicketRequestModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ticket_id']) && (mb_strlen($this->container['ticket_id']) > 10)) {
    ...
    public function setTerminalId($terminal_id)
    {
        if ((mb_strlen($terminal_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling GetTicketRequestModel., must be smaller than or equal to 20.');
        }
     ...
     * Sets ticket_id
     *
     * @param string|null $ticket_id Unique ticket identifier.  Optional
     *
     * @return self
     */
    public function setTicketId($ticket_id)
    {
        if (!is_null($ticket_id) && (mb_strlen($ticket_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $ticket_id when calling GetTicketRequestModel., must be smaller than or equal to 10.');
        }
     ...
     * Sets ticket_status
     *
     * @param string|null $ticket_status The ticket status you want to set. Valid values are 1, 2, 3, 4 (1=Open, 2=Complete, 3=Error, 4=Cancelled)  This field is Mandatory
     *
     * @return self
     */
    public function setTicketStatus($ticket_status)
    {
        ...
        if (!is_null($ticket_status) && (mb_strlen($ticket_status) > 10)) {
            throw new \InvalidArgumentException('invalid length for $ticket_status when calling GetTicketRequestModel., must be smaller than or equal to 10.');
        }
