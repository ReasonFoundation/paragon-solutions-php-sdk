...
/**
 * UpdateMerchantConfigModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMerchantConfigModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMerchantConfigModel';
    ...
    protected static $openAPITypes = [
        ...
        'enable_partial_authorization' => 'string',
    ...
    protected static $setters = [
        ...
        'enable_partial_authorization' => 'setEnablePartialAuthorization',
    ...
    protected static $getters = [
        ...
        'enable_partial_authorization' => 'getEnablePartialAuthorization',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['enable_partial_authorization'] = $data['enable_partial_authorization'] ?? null;
     ...
     *
     * @param string|null $enable_auto_settlement Valid Values \"T\" or \"F\".Enable (T), Can enable auto settlement
     *
     * @return self
     */
     ...
     *
     * @param string|null $allow_duplicate_invoice_number Valid Values \"T\" or \"F\". Enable (T), allow new invoice number to be required when multiple transactions with same payment method and amount are processed for the same time period.
     *
     * @return self
     */
    ...
    public function setEnableDuplicateCheck($enable_duplicate_check)
    {
        if (!is_null($enable_duplicate_check) && (mb_strlen($enable_duplicate_check) > 1)) {
            throw new \InvalidArgumentException('invalid length for $enable_duplicate_check when calling UpdateMerchantConfigModel., must be smaller than or equal to 1.');
        }
     ...
     *
     * @param string|null $require_pnref_for_refunds require_pnref_for_refunds
     *
     * @return self
     */
    public function setRequirePnrefForRefunds($require_pnref_for_refunds)
    {
        if (!is_null($require_pnref_for_refunds) && (mb_strlen($require_pnref_for_refunds) > 1)) {
            throw new \InvalidArgumentException('invalid length for $require_pnref_for_refunds when calling UpdateMerchantConfigModel., must be smaller than or equal to 1.');
        }
     ...
     *
     * @param string|null $enable_daily_transaction_summary_report_email Valid Values \"T\" or \"F\". Enable (T), Can send daily transaction summary report emails.
     *
     * @return self
     */
     ...
     *
     * @param string|null $require_invoice_number Valid Values \"T\" or \"F\". Enable (T), Require invoice number.
     *
     * @return self
     */
     ...
     *
     * @param string|null $require_level_2_data Valid Values \"T\" or \"F\". Enable (T), Require Level 2 data.
     *
     * @return self
     */
     ...
     *
     * @param string|null $collect_level_3_data Valid Values \"T\" or \"F\". Enable (T), Can Collect Level 3 data.
     *
     * @return self
     */
     ...
     *
     * @param string|null $enable_hosted_payment_page Valid Values \"T\" or \"F\". Enable (T), Can use Hosted Payments Page.
     *
     * @return self
     */
     ...
     *
     * @param string|null $enable_fraud_control_suite Valid Values \"T\" or \"F\". Enable (T), Can use Fraud Control Suites.
     *
     * @return self
     */
     ...
     *
     * @param string|null $enable_card_account_updater Valid Values \"T\" or \"F\". Enable (T) Can use Card Account Updater.
     *
     * @return self
     */
     ...
     *
     * @param string|null $enable_offline_batch_tool Valid Values \"T\" or \"F\". Enable (T), Can to use Offline Batch tool.
     *
     * @return self
     */
    ...
    /**
     * Gets enable_partial_authorization
     *
     * @return string|null
     */
    public function getEnablePartialAuthorization()
    {
        return $this->container['enable_partial_authorization'];
    }

    /**
     * Sets enable_partial_authorization
     *
     * @param string|null $enable_partial_authorization Valid Values \"T\" or \"F\". Enable (T), Can support partial authorizations
     *
     * @return self
     */
    public function setEnablePartialAuthorization($enable_partial_authorization)
    {
        $this->container['enable_partial_authorization'] = $enable_partial_authorization;
     ...
     *
     * @param string|null $enable_expired_card_validation_bypass Enable (T) Paragon platform to bypass validation of credit card expiration date.
     *
     * @return self
     */
     ...
     *
     * @param string|null $has_email_receipts_access Valid Values \"T\" or \"F\". Enable (T), Can have email receipt access.
     *
     * @return self
     */
