...
/**
 * UpdateMerchantRequestModel Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMerchantRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMerchantRequestModel';
    ...
    protected static $openAPITypes = [
        ...
        'configuration' => '\DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantConfigModel',
        'contact' => '\DCarbone\ParagonSolutionsPHPSDK\Model\ContactModel',
        'virtual_terminal' => '\DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantVirtualTerminalModel',
        'fraud_control_suite_configuration' => '\DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantCardVerificationModel'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['time_zone_offset']) && (mb_strlen($this->container['time_zone_offset']) > 6)) {
    ...
    public function setPrimaryMerchantId($primary_merchant_id)
    {
        if (!is_null($primary_merchant_id) && (mb_strlen($primary_merchant_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $primary_merchant_id when calling UpdateMerchantRequestModel., must be smaller than or equal to 30.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        if (!is_null($merchant_id) && (mb_strlen($merchant_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling UpdateMerchantRequestModel., must be smaller than or equal to 50.');
        }
    ...
    public function setAnnualSales($annual_sales)
    {
        if (!is_null($annual_sales) && (mb_strlen($annual_sales) > 18)) {
            throw new \InvalidArgumentException('invalid length for $annual_sales when calling UpdateMerchantRequestModel., must be smaller than or equal to 18.');
        }
    ...
    public function setBusinessStartDate($business_start_date)
    {
        if (!is_null($business_start_date) && (mb_strlen($business_start_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $business_start_date when calling UpdateMerchantRequestModel., must be smaller than or equal to 10.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if ((mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling UpdateMerchantRequestModel., must be smaller than or equal to 50.');
        }
    ...
    public function setDoingBusinessAs($doing_business_as)
    {
        if (!is_null($doing_business_as) && (mb_strlen($doing_business_as) > 50)) {
            throw new \InvalidArgumentException('invalid length for $doing_business_as when calling UpdateMerchantRequestModel., must be smaller than or equal to 50.');
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 50)) {
            throw new \InvalidArgumentException('invalid length for $url when calling UpdateMerchantRequestModel., must be smaller than or equal to 50.');
        }
    ...
    public function setFederalTaxId($federal_tax_id)
    {
        if (!is_null($federal_tax_id) && (mb_strlen($federal_tax_id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $federal_tax_id when calling UpdateMerchantRequestModel., must be smaller than or equal to 25.');
        }
    ...
    public function setStateTaxId($state_tax_id)
    {
        if (!is_null($state_tax_id) && (mb_strlen($state_tax_id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $state_tax_id when calling UpdateMerchantRequestModel., must be smaller than or equal to 25.');
        }
    ...
    public function setSalesTaxId($sales_tax_id)
    {
        if (!is_null($sales_tax_id) && (mb_strlen($sales_tax_id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $sales_tax_id when calling UpdateMerchantRequestModel., must be smaller than or equal to 25.');
        }
    ...
    public function setOwnershipType($ownership_type)
    {
        if (!is_null($ownership_type) && (mb_strlen($ownership_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $ownership_type when calling UpdateMerchantRequestModel., must be smaller than or equal to 25.');
        }
     ...
     *
     * @param string|null $time_zone_offset Offset from Coordinated Universal Time(in minutes).
     *
     * @return self
     */
    public function setTimeZoneOffset($time_zone_offset)
    {
        if (!is_null($time_zone_offset) && (mb_strlen($time_zone_offset) > 6)) {
            throw new \InvalidArgumentException('invalid length for $time_zone_offset when calling UpdateMerchantRequestModel., must be smaller than or equal to 6.');
        }
     ...
     *
     * @param string|null $is_test_merchant Enable (T), Is merchant a test merchant?
     *
     * @return self
     */
     ...
     * Gets configuration
     *
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantConfigModel|null
     */
     ...
     * Sets configuration
     *
     * @param \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantConfigModel|null $configuration configuration
     *
     * @return self
     */
     ...
     *
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantVirtualTerminalModel|null
     */
     ...
     *
     * @param \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantVirtualTerminalModel|null $virtual_terminal virtual_terminal
     *
     * @return self
     */
     ...
     *
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantCardVerificationModel|null
     */
     ...
     *
     * @param \DCarbone\ParagonSolutionsPHPSDK\Model\UpdateMerchantCardVerificationModel|null $fraud_control_suite_configuration fraud_control_suite_configuration
     *
     * @return self
     */
