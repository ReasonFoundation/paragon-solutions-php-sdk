...
/**
 * PaymentMethodEBT Class Doc Comment
 *
 * @category Class
 * @package  DCarbone\ParagonSolutionsPHPSDK
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodEBT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodEBT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reimbursement_attribute'] = $data['reimbursement_attribute'] ?? null;
        ...
        $this->container['fcs_id'] = $data['fcs_id'] ?? null;
    }
    ...
    public function setCustomerServicePhoneNumber($customer_service_phone_number)
    {
        ...
        if (!is_null($customer_service_phone_number) && (mb_strlen($customer_service_phone_number) < 11)) {
            throw new \InvalidArgumentException('invalid length for $customer_service_phone_number when calling PaymentMethodEBT., must be bigger than or equal to 11.');
        }
    ...
    public function setPurefacOrMarketplaceId($purefac_or_marketplace_id)
    {
        if (!is_null($purefac_or_marketplace_id) && (mb_strlen($purefac_or_marketplace_id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $purefac_or_marketplace_id when calling PaymentMethodEBT., must be smaller than or equal to 11.');
        }
    ...
    public function setPspName($psp_name)
    {
        if (!is_null($psp_name) && (mb_strlen($psp_name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $psp_name when calling PaymentMethodEBT., must be smaller than or equal to 20.');
        }
     ...
     *
     * @param string|null $settlement_agent_number Settlement Agent Number
     *
     * @return self
     */
     ...
     *
     * @param string|null $reimbursement_attribute Reimbursement Attribute
     *
     * @return self
     */
     ...
     * Sets sharing_group
     *
     * @param string|null $sharing_group Sharing Group
     *
     * @return self
     */
     ...
     * Sets aba_number
     *
     * @param string|null $aba_number ABA Number
     *
     * @return self
     */
     ...
     * Sets surcharge
     *
     * @param string|null $surcharge Surcharge Amount
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getFcsId()
    {
        return $this->container['fcs_id'];
    }

    /**
     * Sets fcs_id
     *
     * @param string|null $fcs_id FCS ID
     *
     * @return self
     */
    public function setFcsId($fcs_id)
    {
        $this->container['fcs_id'] = $fcs_id;
