...
class UtilityApi
{
     ...
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\UtilityRequestModel $util_request util_request (required)
     *
     * @throws \DCarbone\ParagonSolutionsPHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel
     */
    public function v2UtilityPost($authorization, $util_request)
    {
        list($response) = $this->v2UtilityPostWithHttpInfo($authorization, $util_request);
        return $response;
    }

    /**
     * Operation v2UtilityPostWithHttpInfo
     *
     * Performs various utility processes: Currently supported, bin lookup.
     *
     * @param  string $authorization JWT security token obtained from Identity Server. (required)
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\UtilityRequestModel $util_request (required)
     *
     * @throws \DCarbone\ParagonSolutionsPHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function v2UtilityPostWithHttpInfo($authorization, $util_request)
    {
        $request = $this->v2UtilityPostRequest($authorization, $util_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel',
     ...
     */
    public function v2UtilityPostAsync($authorization, $util_request)
    {
        return $this->v2UtilityPostAsyncWithHttpInfo($authorization, $util_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v2UtilityPostAsyncWithHttpInfo
     *
     * Performs various utility processes: Currently supported, bin lookup.
     *
     * @param  string $authorization JWT security token obtained from Identity Server. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v2UtilityPostAsyncWithHttpInfo($authorization, $util_request)
    {
        $returnType = '\DCarbone\ParagonSolutionsPHPSDK\Model\UtilityResponseModel';
        $request = $this->v2UtilityPostRequest($authorization, $util_request);
    ...
    /**
     * Create request for operation 'v2UtilityPost'
     *
     * @param  string $authorization JWT security token obtained from Identity Server. (required)
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\UtilityRequestModel $util_request (required)
     *
     ...
     */
    public function v2UtilityPostRequest($authorization, $util_request)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling v2UtilityPost'
            );
        }
        // verify the required parameter 'util_request' is set
        if ($util_request === null || (is_array($util_request) && count($util_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $util_request when calling v2UtilityPost'
            );
        }

        $resourcePath = '/v2/utility';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($util_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($util_request));
            } else {
                $httpBody = $util_request;
            }
