...
class IdentityApi
{
    ...
    /**
     * Operation v2IdentityPost
     *
     * Obtain bearer tokens to perform operations on the API.
     *
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\ApplicationUserModel $application_user User Credentials to generate the token. (required)
     *
     * @throws \DCarbone\ParagonSolutionsPHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse
     */
    public function v2IdentityPost($application_user)
    {
        list($response) = $this->v2IdentityPostWithHttpInfo($application_user);
        return $response;
    }

    /**
     * Operation v2IdentityPostWithHttpInfo
     *
     * Obtain bearer tokens to perform operations on the API.
     *
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\ApplicationUserModel $application_user User Credentials to generate the token. (required)
     ...
     * @throws \DCarbone\ParagonSolutionsPHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v2IdentityPostWithHttpInfo($application_user)
    {
        $request = $this->v2IdentityPostRequest($application_user);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse',
     ...
     */
    public function v2IdentityPostAsync($application_user)
    {
        return $this->v2IdentityPostAsyncWithHttpInfo($application_user)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v2IdentityPostAsyncWithHttpInfo
     *
     * Obtain bearer tokens to perform operations on the API.
     *
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\ApplicationUserModel $application_user User Credentials to generate the token. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v2IdentityPostAsyncWithHttpInfo($application_user)
    {
        $returnType = '\DCarbone\ParagonSolutionsPHPSDK\Model\IdentityResponse';
        $request = $this->v2IdentityPostRequest($application_user);
    ...
    /**
     * Create request for operation 'v2IdentityPost'
     *
     * @param  \DCarbone\ParagonSolutionsPHPSDK\Model\ApplicationUserModel $application_user User Credentials to generate the token. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function v2IdentityPostRequest($application_user)
    {
        // verify the required parameter 'application_user' is set
        if ($application_user === null || (is_array($application_user) && count($application_user) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $application_user when calling v2IdentityPost'
            );
        }

        $resourcePath = '/v2/identity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($application_user)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($application_user));
            } else {
                $httpBody = $application_user;
            }
